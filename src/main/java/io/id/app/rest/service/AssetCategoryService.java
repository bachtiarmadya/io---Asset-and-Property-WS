...
import io.id.app.controller.AssetCategoryController;
...
public class AssetCategoryService extends BaseService {
    ...
    public AssetCategoryService() {
        ...
        this.controller = new AssetCategoryController();
    }
    ...
    public Response getAllRole() {
        Response res;
        List<Mastercategory> data = controller.getList();
        if (!data.isEmpty()) {
    ...
    public Response create(Mastercategory input) {
        Response res = null;
    ...
    @Path("/edit")
    @Consumes(MediaType.APPLICATION_JSON)
    public Response update(Mastercategory input) {
        Response res = null;
